...
import {
  Store, TrendingUp, DollarSign, Package,
    ...
    return (
      <section className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-16 py-8">
        <div className="bg-gradient-to-br from-[#141008] via-[#0f0c06] to-[#0a0a0a] border border-gold/20 p-8 sm:p-12 text-center">
          ...
          <p className="text-stone text-sm mb-6">Manage your products, orders, and payouts.</p>
          <Link to="/vendor/dashboard" className="btn-primary inline-flex items-center gap-3">
    ...
    <section className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-16 py-8 sm:py-10">
      <div className="relative overflow-hidden bg-gradient-to-br from-[#141008] via-[#0f0c06] to-[#0a0a0a] border border-gold/15">
        ...
        <div
          ...
          style={{ background: 'radial-gradient(circle, #c9a96e 0%, transparent 70%)', filter: 'blur(40px)' }}
        />
        ...
        <div className="relative z-10 p-8 sm:p-10 lg:p-14">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 mb-10 sm:mb-12">
            <div className="max-w-xl">
              ...
              <p className="text-stone text-sm sm:text-base leading-relaxed">
                ...
                real-time analytics, and transparent payouts. Start for free today.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3 shrink-0">
              ...
              <Link
                to="/products"
                className="text-center text-xs text-stone/50 hover:text-stone transition-colors"
              >
                Already a vendor?{' '}
                <Link to="/login" className="text-gold hover:text-gold-light underline underline-offset-2">
                  Sign in
                </Link>
              </Link>
            </div>
          ...
          {/* How it works */}
          <div>
            <p className="eyebrow text-stone/30 text-[10px] mb-6">How it works</p>
          ...
          <div className="mt-10 sm:mt-12 pt-8 sm:pt-10 border-t border-white/[0.06] flex flex-col sm:flex-row items-start sm:items-center gap-6 sm:gap-12">
            {[
              ...
              <div key={label}>
                <p className="font-display text-2xl text-cream leading-none">{num}</p>
                <p className="text-stone/40 text-xs mt-1 uppercase tracking-widest">{label}</p>
              </div>
            ))}
            <div className="sm:ml-auto flex items-center gap-2">
              <CheckCircle2 size={14} className="text-emerald-400" />
              <span className="text-stone/50 text-xs">Free to register · No monthly fees</span>
            </div>
          </div>
        </div>
      </div>
