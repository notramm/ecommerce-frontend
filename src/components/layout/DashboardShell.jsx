...
import {
  ...
  ChevronRight, BarChart3, Bell, Image,
    ...
    <div className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-16 pt-6 sm:pt-8 pb-20">
      <div className="grid grid-cols-1 lg:grid-cols-[240px_1fr] xl:grid-cols-[260px_1fr] gap-8 xl:gap-12 items-start">
        ...
        <aside className="lg:sticky lg:top-[calc(var(--nav-height)+24px)]">
          {/* User card */}
          <div className="bg-[#0d0d0d] border border-white/[0.07] p-4 mb-3">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-gold/10 border border-gold/20 flex items-center justify-center text-gold font-display text-lg shrink-0">
              ...
              <div className="min-w-0">
                ...
                <span className={cn(
                  ...
                  user?.role === 'admin' ? 'text-vermillion/60' : 'text-gold/60'
                )}>
                  {user?.role}
                </span>
              </div>
          ...
          <nav className="bg-[#0d0d0d] border border-white/[0.07] overflow-hidden">
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 text-sm text-stone/40 hover:text-vermillion transition-colors border-t border-white/[0.06]"
            >
        ...
        <main>
          {(title || subtitle) && (
            <div className="mb-6 sm:mb-8">
              ...
              {title && <h1 className="font-display text-2xl sm:text-3xl text-cream">{title}</h1>}
            </div>
          )}
          <motion.div
